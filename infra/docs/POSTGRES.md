...
The chart values are in [infra/postgres/values-dev.yaml](../postgres/values-dev.yaml).
...
Datasource username and password are expected from Vault in the current application config. See [VAULT.md](../docs/VAULT.md) for AppRole setup and Vault secret updates.
